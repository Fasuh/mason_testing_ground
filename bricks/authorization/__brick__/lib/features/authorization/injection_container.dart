...
import 'package:{{project_name}}/features/authorization/data/data_sources/local_auth_data_source.dart';
import 'package:{{project_name}}/features/authorization/data/data_sources/remote_auth_data_source.dart';
import 'package:{{project_name}}/features/authorization/data/interceptors/auth_interceptor.dart';
import 'package:{{project_name}}/features/authorization/data/model/token.dart';
import 'package:{{project_name}}/features/authorization/data/repositories/auth_repository_impl.dart';
...
import 'package:{{project_name}}/features/authorization/domain/use_cases/sign_out_usecase.dart';
...
import 'package:{{project_name}}/features/authorization/presentation/blocs/login_bloc/login_bloc.dart';
